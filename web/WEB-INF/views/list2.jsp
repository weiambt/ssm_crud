...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 style="text-align: center">SSM-CRUD</h1>
        </div>
    </div>
    <!-- 按钮 -->
    <div class="row">
        <div class="col-md-3 col-md-offset-9">
            <button class="btn btn-primary" id="emp_add_modal_btn" style="margin-left:8px;">新增</button>
    ...
    <button onclick="tes(1)">按钮</button>
...
<script type="text/javascript">
    ...
    function validate_add_form(){
        if(validate_add_form_EmpName()==false)
            return false;
        return validate_add_form_Email();
    }
